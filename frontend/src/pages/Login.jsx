...
export default function Login() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      const msg = err?.response?.data?.detail || 'Could not log in. Check your email and password.'
      setError(msg)
    } finally {
      setLoading(false)
    }
  ...
  return (
    <div style={{ maxWidth: '380px', margin: '0 auto', padding: '4rem 1rem' }}>
      <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
        ...
        <p style={{ color: '#94a3b8', fontSize: '14px' }}>Log in to save and revisit your results</p>
      </div>
